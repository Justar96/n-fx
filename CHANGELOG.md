...
- **Upstream fx 0.0.6 foundation:** Bring n-fx onto the latest provider, session, terminal, MCP, authentication, and safety architecture from fx 0.0.6 while retaining CLIProxyAPI support
- **Provider choices:** Add the upstream Codex and Grok subscription providers alongside Vercel AI Gateway and CLIProxyAPI
